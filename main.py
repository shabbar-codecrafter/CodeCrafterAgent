    ...
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
        ...
        {meta_html}
            ...
            <div style="text-align: center; margin-top: 24px; padding-top: 12px; border-top: 1px solid #e5e7eb; color: #9ca3af; font-size: 0.8em;">
                Generated by CodeCrafter AI 🤖 this bot is from osmos <img src="https://instasize.com/api/image/4e76861d6fb4c8ccb704a87644c91657d025f13a4fe6e44778c89d991dcd45a8.jpeg" style="height: 12px; vertical-align: middle; margin-left: 4px;">
            </div>
        </div>
        """
                ...
                try:
                    ...
                    if current_state == "NEW":
                        ...
                        email_body = get_email_template(
                            ...
                            <p><b>Status:</b> 🏗️ Build & Review in progress with Developer</p>
